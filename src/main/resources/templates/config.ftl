...
<div class="starter-template">
	...
	<form method="post" action="${context}/api/html/config">
		<div class="form-group">
			...
			<input type="email" class="form-control" id="emails" name="notification.recipients" placeholder="emails séparés par des virgules" value="${.data_model["notification.recipients"]}">
		</div>
		<div class="form-group">
